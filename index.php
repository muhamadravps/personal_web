        ...
        <div class="text">About Me</div>
            ...
            <div class = "about-wrapper">
                ...
                <div class = "about-btns">
                    <button type = "button" class = "btn btn-pink"><a href="contact.php" style="color: dark; text-decoration: none;">contact</a></button>
                    <button type = "button" class = "btn btn-pink"><a href="project.php" style="color: dark; text-decoration: none;">project</a></button>
                </div>
